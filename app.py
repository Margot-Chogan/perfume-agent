...
with st.container():
    ...
    with c1:
        if st.button("Search", use_container_width=True):
            ...
            st.query_params["perfume_name"] = perfume_name
            st.query_params["brand_name"] = brand_name
            st.query_params["notes_text"] = notes_text
            st.query_params["gender_choice"] = gender_choice
